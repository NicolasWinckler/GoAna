...
#  file(MAKE_DIRECTORY ${new_path}/data)
  ...
  if(CMAKE_SYSTEM MATCHES Darwin)
    ...
    IF(GOANA_FOUND)
    configure_file(${GOANA_CMAKEMOD_DIR}/scripts/set_env_macos.sh.in
    ...
    IF(GOANA_FOUND)
    configure_file(${GOANA_CMAKEMOD_DIR}/scripts/set_env.sh.in
                   ${new_path}/${shell_script_name}
                  )
    ELSE(GOANA_FOUND)
...
IF(GOANA_FOUND)
  ...
  Add_Custom_Command(TARGET svnheader 
		     ...
		     -DBINARY_DIR=${CMAKE_BINARY_DIR}	      
                     ...
                     -DGOANA=${GOANA_CMAKEMOD_DIR}
                     -P ${GOANA_CMAKEMOD_DIR}/modules/GenerateVersionInfo.cmake
                      )
ELSE(GOANA_FOUND)
  Add_Custom_Target(svnheader ALL)
...
IF(GOANA_FOUND)
  ...
  Set(FAIRLIBDIR ${GOANA_LIBRARY_DIR})
